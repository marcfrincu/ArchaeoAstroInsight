...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'a2i_dialog_base.ui'))


class ArchaeoAstroInsightDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(ArchaeoAstroInsightDialog, self).__init__(parent)
